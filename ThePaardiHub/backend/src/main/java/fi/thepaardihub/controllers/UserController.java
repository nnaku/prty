...
public class UserController {
	...
	public void fakeData() {
		...
		UserAccounts add1 = new UserAccounts("nAku",this.pswHasher.getSaltedHash("aku.kangas"),"Aku","Kangas","Aku.Kangas@metropolia.fi");
		UserAccounts add2 = new UserAccounts("Matti",this.pswHasher.getSaltedHash("matti.holopainen"),"Matti","Holopainen","Matti.holopainen2@metropolia.fi");
		UserAccounts add3 = new UserAccounts("Tiina",this.pswHasher.getSaltedHash("tiina.ojala"),"Tiina","Ojala","Tiina.Ojala3@metropolia.fi");
		UserAccounts add4 = new UserAccounts("Maarit",this.pswHasher.getSaltedHash("maarit.saariniemi"),"Maarit","Saariniemi","Maarit.Saariniemi@Metropolia.fi");
